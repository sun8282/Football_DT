    ...
    return (
      <>
        <div className="examcontainer">
          <button className="chooselang eng" onMouseDown={chooseLang}>
            <h5>Eng</h5>
          </button>
          <button className="chooselang kr" onMouseDown={chooseLang}>
            <h5>Kr</h5>
          </button>
            ...
            <div className="stepbox">
              <div className="step1">
                <label htmlFor="input1">
                  <h2 className="act" onClick={Clickstep}>
                    Step 1
                  </h2>
                </label>
              </div>
            ...
            <div className="stepbox">
              <div className="step2">
                <label htmlFor="input2">
                  <h2 onClick={Clickstep}>Step 2</h2>
                </label>
              </div>
              <p>소속 팀 보고 선수 맞추기</p>
            </div>
            <div className="stepbox">
              <div className="step3">
                <label htmlFor="input3">
                  <h2 onClick={Clickstep}>Step 3</h2>
                </label>
              </div>
              <p>스쿼드 보고 팀 이름 맞추기</p>
            </div>
          ...
          <div className="exambox ">
            ...
            <button className="done" onClick={answerSubmit}>
              Done
            </button>
          </div>
        </div>
